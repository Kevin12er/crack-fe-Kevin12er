                ...
                {daftarLatihan.map((item) => (
                  ...
                  >
                    <div className="space-y-2">
                      ...
                      <h3 className="text-lg font-bold text-primary">{item.judul}</h3>
                    ...
                    >
                      {item.status === "Selesai" ? "Sudah Dikerjakan" : "Mulai Kerjakan"}
                    </button>
                  </div>
                ))}
              </div>
          ...
          {activeQuiz && (
            <div className="bg-surface border border-line rounded-2xl p-6 md:p-8 space-y-6">
              <div className="flex justify-between items-center border-b border-line pb-4">
                <div>
                  <h2 className="text-xl font-bold text-primary">{activeQuiz.judul}</h2>
                  <p className="text-xs text-secondary mt-1">{activeQuiz.mapel}</p>
                </div>
                <button
              ...
              <div className="space-y-6">
                {activeQuiz.soal.map((q, idx) => (
                  <div key={q.id} className="bg-base border border-line p-5 rounded-2xl space-y-3">
