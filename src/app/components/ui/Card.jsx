...
function FeatureCard({ icon, title, description }) {
  return (
    <div className="bg-surface border border-line-card rounded-2xl p-6 flex flex-col gap-4 transition translate hover:border-brand-hover">
      <div className="w-12 h-12 rounded-xl bg-(--color-brand-soft) flex items-center justify-center text-2xl">
        {icon}
      </div>
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted font-jakarta text-sm leading-relaxed">
          {description}
        </p>
      </div>
    </div>
